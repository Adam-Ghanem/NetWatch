...
- Added OIDC, fail-closed bearer precedence, audit integrity, readiness, identity privacy, schema migration, launcher key-separation, and UI regression tests; upgraded SQLite schema to version 8.
