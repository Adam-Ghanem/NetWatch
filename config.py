...
MAX_CAPTURE_BYTES = _env_int(
    "NETWATCH_MAX_CAPTURE_BYTES",
    5 * 1024 * 1024,
    minimum=64 * 1024,
    maximum=25 * 1024 * 1024,
)
MAX_CAPTURE_PACKETS = _env_int(
    "NETWATCH_MAX_CAPTURE_PACKETS",
    10_000,
    minimum=100,
    maximum=50_000,
)
MAX_CAPTURE_ROWS = _env_int(
    "NETWATCH_MAX_CAPTURE_ROWS",
    2_000,
    minimum=100,
    maximum=5_000,
)
MAX_CONCURRENT_CAPTURE_ANALYSES = _env_int(
    "NETWATCH_MAX_CONCURRENT_CAPTURE_ANALYSES",
    1,
    maximum=4,
)
