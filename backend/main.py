...
@app.post("/api/traffic/offline/export.{export_format}")
async def export_offline_capture_flows(
    ...
    if export_format == "json":
        content = export_flows_json(flows, limit=flow_limit)
        media_type = "application/json"
    elif export_format == "csv":
        content = export_flows_csv(flows, limit=flow_limit)
        media_type = "text/csv; charset=utf-8"
    else:
        content = export_flows_ndjson(flows, limit=flow_limit)
