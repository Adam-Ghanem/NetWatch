...
| P1 | Service reachability change intelligence | Retained service findings produce evidence-safe reachability transitions and now attach configurable, evidence-gated alert recommendations for newly reachable high-risk or remote-administration services. Filtered/timeouts never generate downtime or reachability alerts. | Add debounce/deduplication and delivery hooks so repeated observations cannot create alert noise. |
